...
class BiditemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'finished' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'finished' => 'Lorem ipsum dolor sit amet',
                'endtime' => '2019-05-19 13:20:20',
                'created' => '2019-05-19 13:20:20'
            ],
        ];
        parent::init();
    }
